...
5. **Пути вне `content/`:** внутри каждого код-спана регуляркой
   ...
   из сценариев user-story в `content/30-requirements/2026-05-08-diagram-on-demand-design.md` и
   `content/00-project/adr/0010-mermaid-file-based-workflow.md` — они не претендуют быть путём в этом
...
- **Есть хотя бы одна прозаическая входящая ссылка (9 из 42, 21%):** ADR-0008 и требования/AT-design
  ...
  `content/60-implementation/test-reports/2026-08-12-wave-4.2.0-qa-report.md`, плюс
...
- Готовый рабочий прецедент есть: реестр `content/00-project/adr/_index.md` — таблица «номер →
