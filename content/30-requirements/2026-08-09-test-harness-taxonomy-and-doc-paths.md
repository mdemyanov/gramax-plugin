...
- **FR-021:** `plugins/gramax/CHANGELOG.md` — новая секция `## 4.1.1` с подразделом `### Fixed`, перечисляющим минимум: миграцию формата тега в `writer/SKILL.md` и `README.md`, добавление WARNING по ADR-0008, удаление мёртвых guard'ов из `check.sh`.
...
- Все FR-001…FR-033 реализованы, AC-001…AC-034 проходят.
...
**Acceptance Criteria для проверки архитектуры:** AC-001, AC-003, AC-005, AC-013, AC-017, AC-018, AC-024, AC-027, AC-034.
