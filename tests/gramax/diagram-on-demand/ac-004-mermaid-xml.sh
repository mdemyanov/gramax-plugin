...
# Spec: content/30-requirements/2026-05-08-diagram-on-demand-design.md (AC-001, FR-001, FR-003, FR-004)
# ADR: content/00-project/adr/0005-save-flow-script-api-contract.md (раздел 6: формат XML-syntax)
