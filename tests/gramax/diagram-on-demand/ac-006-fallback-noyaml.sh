...
# Spec: content/30-requirements/2026-05-08-diagram-on-demand-design.md (AC-006, FR-006)
# ADR: content/00-project/adr/0005-save-flow-script-api-contract.md (раздел 1: fallback при exit 1)
