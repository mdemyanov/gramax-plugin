...
Точный URL репозитория `nauta` — внутренний, в публичном marketplace не публикуется;
уточните его у команды, которая ведёт этот репозиторий.
